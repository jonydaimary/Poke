...
module.exports.run = async (client, message, args) => {   
  let embed = new Discord.RichEmbed()
    ...
    .addField("Bot invite link", "https://discordapp.com/api/oauth2/authorize?client_id=608978244582244365&permissions=130192&scope=bot")
    .addField("Server invite link", "https://discord.gg/yVuXbW5");
